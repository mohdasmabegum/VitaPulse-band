...
class ResultScreen extends StatelessWidget {
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              title: const Text('Your Recommendation', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  child: Padding(
                    ...
                    child: Row(children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(color: _levelBg(n['level']), borderRadius: BorderRadius.circular(10), border: Border.all(color: _levelColor(n['level']).withOpacity(0.3))),
                        child: Text(n['level'].toString().toUpperCase(), style: TextStyle(color: _levelColor(n['level']), fontSize: 11, fontWeight: FontWeight.bold)),
                      ),
                    ]),
                  ),
                )),
                ...
                ...suggestions.map((s) => Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Row(children: [
                        Container(width: 4, height: 20, decoration: BoxDecoration(color: const Color(0xFF00897B), borderRadius: BorderRadius.circular(2))),
                        const SizedBox(width: 8),
                        Expanded(child: Text(s['purpose'], style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
                      ]),
                ...
                Container(
                  ...
                  child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    const SizedBox(width: 8),
                    Expanded(child: Text(disclaimer, style: TextStyle(fontSize: 11, color: Colors.amber.shade900))),
                  ]),
                ),
  ...
  Widget _sectionTitle(String t) => Text(t, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF004D40)));
  ...
  Widget _mealRow(String emoji, String label, dynamic items) => Row(
    ...
    children: [
      ...
      const SizedBox(width: 10),
      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(label, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Color(0xFF004D40))),
        const SizedBox(height: 2),
        Text((items as List?)?.join(', ') ?? '—', style: TextStyle(fontSize: 12, color: Colors.grey.shade700)),
      ])),
    ],
  );
}
